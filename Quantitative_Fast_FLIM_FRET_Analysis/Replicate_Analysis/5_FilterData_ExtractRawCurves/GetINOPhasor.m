...
% getting TCPSPC counts for a single decays, determine the phasor coordinates
% using laser pulse and time bin information used in the INO FLIM-HS confocal system
