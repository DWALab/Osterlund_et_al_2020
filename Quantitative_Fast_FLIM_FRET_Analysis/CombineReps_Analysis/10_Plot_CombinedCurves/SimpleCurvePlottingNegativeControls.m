...
path_to_binned_reps = 'E:\FinalScreenData\mim2_Bcl2\CombineReps_Analysis\5_CombineReps\CombinedBinnedReps';  
%Path to combined binned saturation parameter
satpath ='E:\FinalScreenData\mim2_Bcl2\CombineReps_Analysis\5_CombineReps\CombinedBinnedReps'; 
satfile = 'SatParameters_CombinedBinnedReps.xlsx'; 
sat_path = fullfile(satpath,satfile); 
[satnum , sattxt] = xlsread(sat_path); 

%Path to platemap
excel_file = 'E:\FinalScreenData\mim2_Bcl2\Bcl2_platemaps.xlsx';
excel_sheet ='Rep1';

%Path to output plotted figures
path_to_final_graphs = 'E:\FinalScreenData\mim2_Bcl2\CombineReps_Analysis\8_PlotCurves\Negative_Controls';     
...
cells = {{'mC3-Bcl2'}}; 
transfection_references = {{'V-Bad4E'},{'V-BimL4E'},{'V-tBid4E'},{'V-Bik4E'},{'V-Noxa4E'},{'V-Puma4E'}};
negative_references = {{'V-Bad4E'},{'V-BimL4E'},{'V-tBid4E'},{'V-Bik4E'},{'V-Noxa4E'},{'V-Puma4E'}};
% % 
