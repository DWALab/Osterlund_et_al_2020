...
clc; clear all; close all;
    ...
    path_to_binned_data4 = 'directory\' ; 
    ...
    [num4, txt4] = xlsread(excel_file, sheet4);
    [rows,cols] = size(num1); 
    ...
    for i = 1:rows
        ...
        well_pos_rep4 = GetWellPositionInTable(txt4,celltype,transfection,drug,concentration); 
        ...
        if well_pos_rep4 == -1
            ...
            well_4_id = strcat(char(txt4(well_pos_rep4,1)) , num2str(num4(well_pos_rep4-1,1))); 
        end
        ...
        binned_data4_path = strcat(path_to_binned_data4,'combined_',well_4_id,'_binned.csv'); 
        ...
        if isfile(binned_data4_path)
            data4 = csvread(binned_data4_path,2); 
        else 
            data4 = NaN(size(data1)); 
        end 
    
    
        comb_data =vertcat(data1,data2,data3,data4); 
