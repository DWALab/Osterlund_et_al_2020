...
%%% Fucntion used to get well row index from excel sheet
%%% It uses cell line, trasnfection, drug, and drug concentration to search for the well
%%% If well not found a -1 index is returned
